...
export const defaultDate = () => {
  const date = new Date();
  const currentDay = date.getDate().toString().length > 1 ? date.getDate() : '0' + date.getDate();
  const currentMonth = date.getMonth().toString().length > 1 ? Number(date.getMonth() + 1) : '0' + Number(date.getMonth() + 1);
